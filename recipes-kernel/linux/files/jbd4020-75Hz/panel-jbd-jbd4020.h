...
static const struct jbd4020_instr_t jbd4020_init[] = {
    ...
    // from jbd's init sequence
    JBD4020_COMMAND_INSTR(0x03030180, 0x2003D03F),
    JBD4020_COMMAND_INSTR(0x03030300, 0x00000000),
    JBD4020_COMMAND_INSTR(0x0100183C, 0x00001D10),
    
    // SRAM offset
    //JBD4020_COMMAND_INSTR(0x03030008, 0x0000C0C1),  // SRAM offset default
	...
	JBD4020_COMMAND_INSTR(0x01000090, 0x00600F86), //MIPI Clock upon 540Mbps, fps > 60Hz
	//JBD4020_COMMAND_INSTR(0x01000090, 0x00600F80), //MIPI CLock under 540Mbps, fps <= 60Hz
...
static const struct jbd4020_instr_t jbd4020_init_part3[] = {
	...
	JBD4020_COMMAND_INSTR(0x0100003C, 0x2243003F),  //TCON: 67.5M(framerate: 75Hz)
	//JBD4020_COMMAND_INSTR(0x0100003C, 0x2244003F), // TCON: 54MM(framerate: 60Hz)
	//JBD4020_COMMAND_INSTR(0x0100003C, 0x2049003F), //(framerate: 30Hz)
	JBD4020_COMMAND_INSTR(0x02000030, 0x0000FF03),  //Current Mirror set 1X
    JBD4020_COMMAND_INSTR(0x0302AE38, 0x00000BB8),  // Brightness
    JBD4020_COMMAND_INSTR(0x0302AE90, 0x0001000A),  //Pixel Current 1.6uA
	JBD4020_COMMAND_INSTR(0x03030100, 0x80000011),
	...
	JBD4020_COMMAND_INSTR(0x02000040, 0x0020C208),     // jbd's value: 0x0020C208, our init code from jbd: 0x0020C209
	...
	JBD4020_COMMAND_INSTR(0x0302AE68, 0x00000000),  // was 1
	JBD4020_COMMAND_INSTR(0x02003004, 0x0093635B),
	JBD4020_COMMAND_INSTR(0x02003004, 0x05B1DBA5),
...
static const struct jbd4020_instr_t jbd4020_init_part5[] = {
	...
	JBD4020_COMMAND_INSTR(0x01001038, 0x00000002), //Error flag IO to frame sync
...
static const struct jbd4020_instr_t jbd4020_init_part6[] = {
	//Gamma on
	//JBD4020_COMMAND_INSTR(0x0302AE00, 0x00000380), //Gamma on
	JBD4020_COMMAND_INSTR(0x0302AE00, 0x00000300),  //Gamma off
...
static const struct jbd4020_instr_t jbd4020_init_part7[] = {
	...
	JBD4020_COMMAND_INSTR(0x03000200, 0x00000018), //Demura off
    ...
    // Image Offset
    //JBD4020_COMMAND_INSTR(0x0300015C, 0x200C000C),     // VO Offset default
